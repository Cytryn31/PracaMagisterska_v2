namespace PracaMagisterska_v2
{
	partial class Form1
	{
		...
		{
			this.LHong = new System.Windows.Forms.TabPage();
			...
			this.FitlersBank = new System.Windows.Forms.TabPage();
			...
			// LHong
			// 
			this.LHong.Controls.Add(this.thresholdingSelector1);
			this.LHong.Controls.Add(this.normalizationForm1);
			this.LHong.Controls.Add(this.label4);
			this.LHong.Controls.Add(this.textBox4);
			this.LHong.Controls.Add(this.label3);
			this.LHong.Controls.Add(this.textBox3);
			this.LHong.Controls.Add(this.label2);
			this.LHong.Controls.Add(this.textBox2);
			this.LHong.Controls.Add(this.label1);
			this.LHong.Controls.Add(this.textBox1);
			this.LHong.Controls.Add(this.button7);
			this.LHong.Controls.Add(this.button6);
			this.LHong.Controls.Add(this.button5);
			this.LHong.Controls.Add(this.button4);
			this.LHong.Controls.Add(this.button3);
			this.LHong.Controls.Add(this.CalculatedPictureBox);
			this.LHong.Controls.Add(this.ReferencePictureBox);
			this.LHong.Controls.Add(this.button2);
			this.LHong.Controls.Add(this.button1);
			this.LHong.Location = new System.Drawing.Point(4, 22);
			this.LHong.Name = "LHong";
			this.LHong.Padding = new System.Windows.Forms.Padding(3);
			this.LHong.Size = new System.Drawing.Size(1292, 729);
			this.LHong.TabIndex = 1;
			this.LHong.Text = "Hong";
			this.LHong.UseVisualStyleBackColor = true;
			// 
			// label4
			// 
			...
			// tabControl1
			// 
			this.tabControl1.Controls.Add(this.FitlersBank);
			this.tabControl1.Controls.Add(this.LHong);
			...
			// FitlersBank
			// 
			this.FitlersBank.Location = new System.Drawing.Point(4, 22);
			this.FitlersBank.Name = "FitlersBank";
			this.FitlersBank.Padding = new System.Windows.Forms.Padding(3);
			this.FitlersBank.Size = new System.Drawing.Size(1434, 729);
			this.FitlersBank.TabIndex = 0;
			this.FitlersBank.Text = "Fitlers Bank";
			this.FitlersBank.UseVisualStyleBackColor = true;
			// 
			...
			this.Name = "Form1";
			this.Text = "Form1";
			this.LHong.ResumeLayout(false);
			this.LHong.PerformLayout();
		...
		private System.Windows.Forms.TabPage LHong;
		public System.Windows.Forms.PictureBox CalculatedPictureBox;
		public System.Windows.Forms.PictureBox ReferencePictureBox;
		private System.Windows.Forms.Button button2;
		private System.Windows.Forms.Button button1;
		private System.Windows.Forms.TabControl tabControl1;
		private System.Windows.Forms.TabPage FitlersBank;
		...
		private Forms.NormalizationForm normalizationForm1;
